...
>>>>>>> master
	...
	/*
	 * Metodo para consultar segun el tipo de restaurante
	 */
	
	public  ArrayList<Menu> getMenuByName(ArrayList<Menu> menucito, String name){
		ArrayList<Menu> listaNombre = new ArrayList<Menu>(); 
		for(Menu m : menu) {
			if(m.getRestaurante().equals(name)) {
				listaNombre.add(m);
			}
		}
		return listaNombre;
